...
clear
insheet using head_eu_vec_lead2_1.csv
rename v1 head_switch1
destring head_switch1, replace force
save "aux_file.dta", replace
clear
insheet using spouse_nl_vec_lead2_1.csv
rename v1 spouse_out
destring spouse_out, replace force
merge using "aux_file.dta"
...
clear
insheet using head_eu_vec_lead1_1.csv
rename v1 head_switch2
destring head_switch2, replace force
save "aux_file.dta", replace
clear
insheet using spouse_nl_vec_lead1_1.csv
rename v1 spouse_out
destring spouse_out, replace force
merge using "aux_file.dta"
...
clear
insheet using head_eu_vec_lag2_1.csv
rename v1 head_switch5
destring head_switch5, replace force
save "aux_file.dta", replace
clear
insheet using spouse_nl_vec_lag2_1.csv
rename v1 spouse_out
destring spouse_out, replace force
merge using "aux_file.dta"
...
clear
insheet using head_eu_vec_lag1_1.csv
rename v1 head_switch4
destring head_switch4, replace force
save "aux_file.dta", replace
clear
insheet using spouse_nl_vec_lag1_1.csv
rename v1 spouse_out
destring spouse_out, replace force
merge using "aux_file.dta"
